...
/// Draw a pseudo-line between the independent and dependent positions. Returns rounded values as `i64`s. If you don't want the values rounded, use [`interpolate_floating`]
#[must_use]
